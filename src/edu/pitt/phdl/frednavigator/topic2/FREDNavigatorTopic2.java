...
/**
 * File: FredNavigatorTopic2.java
 * Date last modified: 6/14/13 
 *
 * This is called by FredNavigator.java and starts Topic 2
 */
...
public class FREDNavigatorTopic2 extends Application {
  ...
  {
    Parent root = FXMLLoader.load(getClass().getResource(FredNavigatorConstants.TOPIC_TWO_FXML));
